...
/**
 Called when the recorder has listened to an audio buffer
 */
- (void)recorder:(SCRecorder *__nonnull)recorder didListenToAudioSampleBuffer:(CMSampleBufferRef __nullable)sampleBuffer;
